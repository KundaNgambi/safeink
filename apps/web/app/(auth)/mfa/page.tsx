      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex gap-3 justify-center mb-8">
          {code.map((digit, i) => (
            <input
              ...
              style={{
                border: `2px solid ${digit ? '#BEFF46' : 'rgba(255,255,255,0.1)'}`,
                color: '#f0f1f4',
                fontFamily: 'var(--font-jetbrains)',
                boxShadow: digit ? '0 0 12px rgba(190,255,70,0.2)' : 'none',
              }}
              autoFocus={i === 0}
            />
          ))}
        ...
        <button
          ...
          style={{
            ...
            color: isComplete ? '#0f1117' : '#BEFF4666',
        ...
        <p
          ...
          style={{ color: '#555a6e', fontFamily: 'var(--font-manrope)' }}
        >
          Didn&apos;t receive a code?{' '}
          <button style={{ color: '#BEFF46' }} className="font-semibold hover:underline">
            Resend
          </button>
        </p>
      </div>
